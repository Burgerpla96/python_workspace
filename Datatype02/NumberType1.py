...
d=3785365743678562347560437852634876587345608734605283476543782560347
pprint(d)
...
pprint(b)
pprint(a+b)
print('[0.1+0.2연산결과:0.3이 아니다]')#0.30000000000000004
a=0.1
b=0.2
print(a+b)
#파이썬에서 부동 소수점 오차 해결하기
#https://winterj.me/Floating-Point/블로그 참조
#float()함수 :  실수로  변환하는 함수-정수뒤에 .0을 붙인다
pprint(1+2)
print('[정수를 실수로 변환하기]')
pprint(float(1+2))