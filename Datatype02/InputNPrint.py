...
#공백(구분자)이 없을시 : ValueError: not enough values to unpack
#공백(구분자)은 있으나 값이 변수보다 적거나 많은 경우 에러
'''
print('[데이타 여러개 입력받기 - 공백(디폴트) 구분자]')
a,b = input('공백을 기준으로 두 개의 숫자를 입력하세요?').split()
print('a:{},b:{}'.format(a,b))
print('a의 type:{},b의 타입:{}'.format(type(a),type(b)))
c = int(a) + int(b)
print('두 수의 합:',c)
print('[데이타 여러개 입력받기 - 다른 구분자]')
a,b = input('콤마(,)을 기준으로 두 개의 숫자를 입력하세요?').split(',')
...
'''
print('1.여러개 동시에 출력하기:공백(기본값)')
print(a,b,'공백')
print('2.여러개 동시에 출력하기:sep 사용')
print(a,b,'sep키워드 인수사용',sep='▲')
print('2-1.여러개 동시에 출력하기:sep 사용-줄바꿈')
print(a,b,'sep키워드 인수사용',sep='\r\n')#실제 콘손에서 테스트하면 정상.이클립스 콘솔에서는 두번 줄바꿈
print('3.여러개 동시에 출력하기:end 사용')
#print(a,end=' ')
#print(b) 혹은
print(a,b)
print('4.여러개 동시에 출력하기:file 사용-표준에러 출력')
import sys
