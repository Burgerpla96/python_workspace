...
print('국어:{1},영어:{2},수학:{3},평균:{0}'.format(avg,kor,eng,math))
print('[형식 문자열 사용시-str객체의 format()함수:숫자 인덱스 미 사용]')
print('국어:{},영어:{},수학:{},평균:{}'.format(kor,eng,math,avg))
print('[형식 문자열 사용시-str객체의 format()함수:키워드 인수 사용]')
print('국어:{k},영어:{e},수학:{m},평균:{a}'.format(m=math,e=eng,a=avg,k=kor))
#형식 문자열 쓰는 곳에서 특수문자(이스케이프문자) 사용가능
print('[형식문자열에 이스케이프 문자 혼용하기]')
