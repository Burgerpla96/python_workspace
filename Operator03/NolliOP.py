...
print('[연산자 우선순위]')
b = not (num1 !=num2) or num1 >= num2 and num1 == num2
#1](num1 !=num2) : True
#2] not 1]번의 결과=not True : False
#3] num1 >=num2 : True
#4] num1 == num2: False
#중간정리:False or True and False
#5] True and False: False
#6] False or 5]번의 결과 = False or False: False
print('not (num1 !=num2) or num1 >= num2 and num1 == num2의 결과 : %s' % b)
...
print('5*2%3 > 6-2*2 and 10 <= 6*2 or 5*3 !=10 의 결과:{}'.format(b))
print('[단락 평가]')
print(True or False)#첫번째항이 True임으로 두번째항은 검사 안한다.바로 True
print(False  and True)#첫번째항이 False임으로 두번째항은 검사 안한다.바로 False
#※파이썬에는 xor연산자가 따로 없다  xor연산을 하려면 아래와 같은 방법으로 한다
#방법1] bool(값) ^ bool(값)
print('[파이썬의 XOR연산 첫번째]')
print( 3 >2 ^ 3 > 1)#False
print(bool(1) ^ bool(0))#True
print('[파이썬의 XOR연산 두번째]')
#방법2] operator모듈의 xor함수 사용
#C:\Users\KSM06-00\AppData\Local\Programs\Python\Python39\lib\operator.py
import operator
