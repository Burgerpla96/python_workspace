...
print(a is b)#False
print('a의 값:{},a의 주소:{},b의 값:{},b의 주소:{}'.format(a,id(a),b,id(b)))
a=0.0
b=False
print(a == b)#True
print(a is b)#False
...
print('-10:{},3.14:{},"HELLO":{},[1,2,3]:{}'.format(bool(-10),bool(3.14),bool("HELLO"),bool([1,2,3])))
