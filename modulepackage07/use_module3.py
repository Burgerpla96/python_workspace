...
print(dir())#현재 파일의 이름공간 출력.'mathmatics'만 보임.즉 패키지명.모듈명.으로 접근해야 한다['__annotations__', '__builtins__', '__cached__', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', 'mathmathics']
...
print('[import 패키지명]')
import mathmathics
print(dir())#['__annotations__', '__builtins__', '__cached__', '__doc__', '__file__', '__loader__', '__name__', '__package__', '__spec__', 'mathmathics']
#import mathmathics 한 경우 mathmathics를 패키지가 아닌 모듈로 인식이되어
#modulepackage07패키지안에서 mathmathics.py를 찾게된다
#방법은 패키지 초기화 파일(__init__.py설정을 통해 mathmatics를 패키지로 처리할수 있도록 할 수 있다다print(mathmathics.module3.add(10,20))#AttributeError: module 'mathmathics' has no attribute 'module3'
