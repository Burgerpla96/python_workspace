...
print('[리스트 요소의 총합]')
print(sum(a))
#리스트의 요소들은 반드시 숫자(정수 혹은 실수) 혹은 bool 이어야한다
b=[True,100,5,'가']
...
print(list(f))#[3, 5, 8, 1]
#세개의 숫자를  공백을 기준으로 input()함수로 입력받고 각각의 입력받은 값을
#공백을 기준으로  split(리스트 반환)한다  그리고 리스트의 각 요소를 int로 변환하고 list로 만들어
